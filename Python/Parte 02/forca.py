...
def jogar():
    ...
    acertou = analisa_letras_acertadas(palavra_secreta, letras_acertadas)
...
def inicializa_letras_acertadas(palavra_secreta):
    ...
    for i in range(0, len(palavra_secreta), 1):
        letras_acertadas.insert(i, "_")

    return letras_acertadas

def analisa_letras_acertadas(palavra_secreta, letras_acertadas):
    enforcou = False
    acertou = False
    erros = 0
